---
title: Minima
description: Introducing new GTD-based project management tool.
tags: dev
---

It’s been almost 7 years since I shut down Excel and opened text editor to build this MVP.

<Highlight> [minima.app](https://minima.app) </Highlight>
...
<Highlight> You can’t efficiently manage the area that you didn’t master yourself </Highlight>
...
import { highlight as Highlight } from "markdown";
