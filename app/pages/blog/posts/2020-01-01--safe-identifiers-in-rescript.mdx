...
<Note>
  Functor is a function in a modules space. When you call a functor it returns a new module. More on functors in the <A href="https://rescript-lang.org/docs/manual/latest/module#module-functions-functors">official documentation</A>.
</Note>
