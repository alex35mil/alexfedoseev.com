---
title: Safe Routing in ReasonML
description: How to approach a routing in ReasonML.
category: Dev
---
...
- `Route.re`: application routes
- `Router.re`: router specific code
...
<P>
  ...
  <InternalLink path="/blog/dev/2020/reasonml-safe-identifiers">“Safe Identifiers”</InternalLink> post.
