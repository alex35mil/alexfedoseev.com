...
description: Quick intro into ReasonML modules.
category: Dev
---

Recently, I’ve been investing quite a lot in learning [ReasonML](https://reasonml.github.io) and TBH I’m pretty much dead as JS developer right now because I’ve seen the better world. Much better one.
...
<Note>
  By convention, all filenames are capitalized to match module name. You can name file <C>math.re</C> but module name is still capitalized: <C>Math</C>.
</Note>
...
More about the ReasonML modules in the [official documentation](https://reasonml.github.io/docs/en/module.html).
