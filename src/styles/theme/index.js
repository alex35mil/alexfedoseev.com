...
export const postExpandableContentBgColor = "var(--post-expandable-content-bg-color)";
export const postFooterNavLinkHoverBgColor = "var(--post-footer-nav-link-hover-bg-color)";
export const badgeTextColor = "var(--badge-text-color)";
export const badgeBgColor = "var(--badge-bg-color)";
