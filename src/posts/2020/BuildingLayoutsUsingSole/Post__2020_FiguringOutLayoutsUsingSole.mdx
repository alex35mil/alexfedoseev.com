...
> Look at examples of different layouts in <InternalLink path="/blog/travel/2020/turkey">the previous post</InternalLink>.
...
I'm not going to dive into details of the algorithm here. There are dozen of links in Google on the subject. But it's worth mentioning that if you'd like to use it in your code without introducing new dependencies, there is a <A href="https://rosettacode.org/wiki/Gaussian_elimination" targetBlank>dedicated section on RosettaCode</A>, which has implementations of algorithm in a variety of languages.
