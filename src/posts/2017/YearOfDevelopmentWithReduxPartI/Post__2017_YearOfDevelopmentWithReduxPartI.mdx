...
This change greatly improved a performance of the app but introduced some new issues, which are the subject of the <InternalLink path="/blog/2017/year-of-development-with-redux-part-2">Part II</InternalLink>.
