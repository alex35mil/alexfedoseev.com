...
<Highlight>
  <A href="https://github.com/alexfedoseev/tableau">Tableau</A>
</Highlight>
...
<Note>
  ...
  <A href="https://github.com/alexfedoseev/tableau/issues">issue</A> or{" "}
  <A href="https://github.com/alexfedoseev/tableau/pulls">PR</A>!
</Note>
...
<Note>
  Or <A href="https://github.com/alexfedoseev/tableau/archive/master.zip">download it</A> if you are
...
<Expandable label="See it in action">
  <AnimatedGif src={chromeAnimatedGif} placement="bleed" caption="Load Tableau in Chrome" />
</Expandable>
