...
<P>
  The <InternalLink path="/blog/year-of-development-with-redux-part-1">previous post</InternalLink> was about the composition of connected components and performance, but those changes introduced another kind of issues, that was solved by the second insight.
</P>
...
<InlineImage src={uiUnitImage} caption="UI Unit" />
...
<InlineImage src={formImage} caption="Location form" />
...
In the <InternalLink path="/blog/year-of-development-with-redux-part-3">next post</InternalLink> I’ll dive into UI unit folder and share my findings in typing Redux parts with Flow.
