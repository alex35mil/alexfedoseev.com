...
<P>
  The <InternalLink path="/blog/2017/year-of-development-with-redux-part-1">previous post</InternalLink> was about the composition of connected components and performance, but those changes introduced another kind of issues, that was solved by the second insight.
</P>
...
In the <InternalLink path="/blog/2017/year-of-development-with-redux-part-3">next post</InternalLink> I’ll dive into UI unit folder and share my findings in typing Redux parts with Flow.
