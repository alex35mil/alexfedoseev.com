...
import { image as Image, note as Note } from "markdown";
...
<Image src={draftImage} caption="First draft" />
...
<Image src={corsImage} caption="CORS" />
...
<Image src={proxyImage} caption="Proxy" />
